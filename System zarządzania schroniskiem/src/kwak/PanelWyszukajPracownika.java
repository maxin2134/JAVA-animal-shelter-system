...
public class PanelWyszukajPracownika extends JFrame{
    
    private JLabel idEtykieta = new JLabel("ID oracownika");
    private JTextField idPole = new JTextField(11);
    private PolaczenieToolbarOs3 polaczenie;
    private JFrame okno = new JFrame("Wyszukiwanie pracownika");
    private JButton przyciskWyszukaj = new JButton("Wyszukaj");
    JPanel buttonPane = new JPanel();
    JPanel fieldPane = new JPanel();

    
    PanelWyszukajPracownika(){
    ...
    przyciskWyszukaj.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e) {
            ...
            okno.dispose();
            if (polaczenie != null){
                polaczenie.formEventOccurred(id);
    ...
    public void pokazPracownika(PolaczenieToolbarOs3 Formularz){
