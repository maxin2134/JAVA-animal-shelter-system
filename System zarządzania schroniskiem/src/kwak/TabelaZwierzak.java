...
public class TabelaZwierzak extends JPanel {
    
    private JTable tabela;
    private ModelTabelaZwierzak model;
    private JPopupMenu popup;
    private PolaczenieTabelaGui polaczenie;
    
    public TabelaZwierzak (){
        popup = new JPopupMenu();
        model = new ModelTabelaZwierzak();
    ...
    public void wstawDane(ArrayList<FormularzZwierzaka> lista){
