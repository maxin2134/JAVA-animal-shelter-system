...
public class TabelaPracownik extends JPanel {
    
    private JTable tabela;
    private ModelTabelaPracownik model;
    private JPopupMenu popup;
    private PolaczenieTabelaGui polaczenie;
    
    public TabelaPracownik (){
        popup = new JPopupMenu();
        model = new ModelTabelaPracownik();
    ...
    public void wstawDane(ArrayList<FormularzPracownik> lista){
        model.wstawDane(lista);
        model.fireTableStructureChanged();
        
    }
    
    public void usunPracownika(PolaczenieTabelaGui polaczenie){
