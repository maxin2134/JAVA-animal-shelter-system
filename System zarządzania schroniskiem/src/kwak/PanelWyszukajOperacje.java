...
public class PanelWyszukajOperacje extends JFrame{
    
    private JLabel idEtykieta = new JLabel("ID zwierzaka");
    private JTextField idPole = new JTextField(11);
    private PolaczenieToolbarOs3 polaczenie;
    private JFrame okno = new JFrame("Wyszukiwanie operacji");
    private JButton przyciskWyszukaj = new JButton("Wyszukaj");
    JPanel buttonPane = new JPanel();
    JPanel fieldPane = new JPanel();

    
    PanelWyszukajOperacje(){
    ...
    public void pokazOperacje(PolaczenieToolbarOs3 Formularz){
