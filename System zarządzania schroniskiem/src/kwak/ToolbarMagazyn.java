...
public class ToolbarMagazyn extends JPanel implements ActionListener {
    ...
    private JButton przyciskDodajKlienta = new JButton ("Dodaj pracownika");
    private JButton przyciskWyszukajPrzeterminowanyProdukt = new JButton ("Przedawnione produkty");
    ...
    public ToolbarMagazyn(){
        ...
        add(przyciskWyszukajPrzeterminowanyProdukt);
        ...
        przyciskWyszukajPrzeterminowanyProdukt.addActionListener((new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                if(polaczenie6 != null){
