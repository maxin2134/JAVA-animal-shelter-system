...
public class PodgladTabelaZwierzak extends JFrame {
    ...
    PodgladTabelaZwierzak(ArrayList<FormularzZwierzaka> lista){
    ...
    tabelaZwierzakow.wstawDane(lista);
    ...
    przyciskDodaj.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int id = tabelaZwierzakow.zwrocZaznaczenie();
 ...
 public void usunZwierzaka (PolaczenieToolbarOs3 pol){
