...
public class PanelWyszukajTowar extends JFrame{
    
    private JLabel nazwaEtykieta = new JLabel("Nazwa");
    private JTextField nazwaPole = new JTextField(11);
    private PolaczenieToolbarOs3 polaczenie;
    private JFrame okno = new JFrame("Wyszukiwanie towaru");
    ...
    fieldPane.add(nazwaEtykieta, BorderLayout.BEFORE_FIRST_LINE);
    fieldPane.add(nazwaPole,BorderLayout.BEFORE_LINE_BEGINS);
    ...
    przyciskWyszukaj.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e) {
            String pesel = nazwaPole.getText();            
    ...
    public void pokazTowar(PolaczenieToolbarOs3 Formularz){
