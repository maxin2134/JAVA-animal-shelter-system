...
public class ToolbarDokumentacja extends JPanel implements ActionListener {
    ...
    private JButton przyciskDodajKlienta = new JButton ("Dodaj zwierzaka");
