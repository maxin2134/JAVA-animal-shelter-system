...
public class TabelaOsoba extends JPanel {
    
    private JTable tabela;
    private ModelTabelaOsoba model;
    private JPopupMenu popup;
    private PolaczenieTabelaGui polaczenie;
    
    public TabelaOsoba (){
        popup = new JPopupMenu();
        model = new ModelTabelaOsoba();
    ...
    public void wstawDane(ArrayList<FormularzOsoba> lista){
        model.wstawDane(lista);
        model.fireTableStructureChanged();
        
    }
    
    public void usunOsoba(PolaczenieTabelaGui polaczenie){
