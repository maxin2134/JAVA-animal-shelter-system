...
public class ToolbarOperacja extends JPanel implements ActionListener {
    ...
    private JButton przyciskDodajZwierzaka = new JButton ("Dodaj zwierzaka");
    private JButton przyciskDodajPracownika = new JButton ("Dodaj pracownika");
    ...
    private PolaczenieToolbarOs7 polaczenie7;
    
    private JTextField ID = new JTextField(3);
    
    public ToolbarOperacja(){
        ...
        add(przyciskDodajZwierzaka);
        add(przyciskDodajPracownika);
        ...
        przyciskDodajZwierzaka.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                if (polaczenie6 != null){
        ...
        przyciskDodajPracownika.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                if (polaczenie7 != null)
                    polaczenie7.formEventOccurred();
            }
        });
    }
    ...
    public void polToolbarOs7 (PolaczenieToolbarOs7 pol){
        this.polaczenie7 = pol;
    }
