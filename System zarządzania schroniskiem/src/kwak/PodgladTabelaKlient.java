...
public class PodgladTabelaKlient extends JFrame {
    ...
    PodgladTabelaKlient(ArrayList<FormularzKlienta> lista){
    ...
    tabelaKlient.wstawDane(lista);
    
    okno.setTitle("Dodaj klienta");
    okno.add(contentPane, BorderLayout.SOUTH);
    okno.add(tabelaKlient, BorderLayout.CENTER);
    ...
    przyciskDodaj.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int id = tabelaKlient.zwrocZaznaczenie();
