...
public class PanelWyszukajKlienta extends JFrame{
    ...
    private JFrame okno = new JFrame("Wyszukiwanie klienta");
    private JButton przyciskWyszukaj = new JButton("Wyszukaj");
    JPanel buttonPane = new JPanel();
    JPanel fieldPane = new JPanel();

    
    PanelWyszukajKlienta(){
    ...
    public void pokazKlienta(PolaczenieToolbarOs3 Formularz){
